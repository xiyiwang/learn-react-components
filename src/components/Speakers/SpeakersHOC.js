  ...
  return (
    <div className={bgColor}>
      ...
      {specialMessage && specialMessage.length > 0 && (
        <div
          className="bg-yellow-50 border-l-8 border-yellow-600 text-yellow-600 p-4 text-2xl"
          role="alert"
        >
...
export default compose(
  withRequest("http://localhost:4242", "speakers"),
  withSpecialMessage()
)(Speakers);

// export default withSpecialMessage(
//   withRequest("http://localhost:4242", "speakers")(Speakers)
// );
